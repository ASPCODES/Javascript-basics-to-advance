...
myArr.push(6, 7)   //The elements add at the end of the array.
...
const newArr = myArr.join()  // Add all the elements of an array and bind them and also converted into strings. 
